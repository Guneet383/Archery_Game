...
public class archery {
    ...
    private static int targetSpeed = 3;
    ...
    public static void main(String[] args) {
        ...
        JPanel backgroundPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon backgroundImage = new ImageIcon("C:/Users/HPPC/Desktop/Archery/background3.png");
        ...
        // Bow label
        ImageIcon bowIcon = new ImageIcon("C:/Users/HPPC/Desktop/Archery/bow.png");
        ...
        bowLabel.setBounds(20, 250, 300, 300);
        layeredPane.add(bowLabel, new Integer(1));

        // Target label
        JLabel targetPanel = new JLabel();
        ImageIcon targetImage = new ImageIcon("C:/Users/HPPC/Desktop/Archery/target.png");
        targetPanel.setIcon(targetImage);
        targetPanel.setOpaque(false);
        targetPanel.setBounds(1200, 200, 149, 188);
        ...
        hearts = new JLabel[5];
        for (int i = 0; i < 5; i++) {
            ImageIcon heartIcon = new ImageIcon("C:/Users/HPPC/Desktop/Archery/heart_red.png");
            hearts[i] = new JLabel();
        ...
        controlPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                super.paintComponent(g);
                ImageIcon background = new ImageIcon("C:/Users/HPPC/Desktop/Archery/control.png"); // 
        ...
        // Start button
        ImageIcon startButtonIcon = new ImageIcon("C:/Users/HPPC/Desktop/Archery/start.png");
        ...
        ImageIcon highScoreButton = new ImageIcon("C:/Users/HPPC/Desktop/Archery/highscore.png");
    ...
    private static void fireArrow(JLayeredPane layeredPane, int targetX, int targetY, int startX, int startY,
        ...
        ImageIcon arrowIcon = new ImageIcon("C:/Users/HPPC/Desktop/Archery/arrow.png");
    ...
    if (missedShotsCount < 5) {
        for (int i = 0; i < 5; i++) {
            if (i < missedShotsCount) {
                hearts[i].setIcon(new ImageIcon("C:/Users/HPPC/Desktop/Archery/heart_grey.png"));
            } else {
                hearts[i].setIcon(new ImageIcon("C:/Users/HPPC/Desktop/Archery/heart_red.png"));
            }
        }
    }
}
